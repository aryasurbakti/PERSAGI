...
import { getFirestore } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js"; // Tambahkan ini
...
const firebaseConfig = {
  ...
  measurementId: "G-D32WHFHKTC"
};

const app = initializeApp(firebaseConfig);
export const auth = getAuth(app);
export const db = getFirestore(app); // Ekspor ini sangat penting!
